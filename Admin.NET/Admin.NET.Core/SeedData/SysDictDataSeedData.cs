...
public class SysDictDataSeedData : ISqlSugarEntitySeedData<SysDictData>
{
    ...
    public IEnumerable<SysDictData> HasData()
    {
        return new[]
        {
            ...
            new SysDictData{ Id=1300000000507, DictTypeId=1300000000105, Value="无基类", Code="None", OrderNo=1, Remark="【无基类】", Status=StatusEnum.Disable, CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
