...
public class SysOrgSeedData : ISqlSugarEntitySeedData<SysOrg>
{
    ...
    public IEnumerable<SysOrg> HasData()
    {
        return new[]
        {
            new SysOrg{ Id=252885263003720, Pid=0, Name="华北地区", Code="1001", CreateTime=DateTime.Parse("2022-02-10 00:00:00"), Remark="华北地区", TenantId=142307070918780 },
            ...
            new SysOrg{ Id=252885263003730, Pid=0, Name="华东地区", Code="1002", CreateTime=DateTime.Parse("2022-02-10 00:00:00"), Remark="华东地区", TenantId=142307070918780 },
            ...
            new SysOrg{ Id=252885263003740, Pid=0, Name="华南地区", Code="1003", CreateTime=DateTime.Parse("2022-02-10 00:00:00"), Remark="华南地区", TenantId=142307070918780  },
            ...
            new SysOrg{ Id=252885263003750, Pid=0, Name="租户1公司", Code="2001", CreateTime=DateTime.Parse("2022-02-10 00:00:00"), Remark="租户1公司" , TenantId=142307070918781 },
        };
    }
}