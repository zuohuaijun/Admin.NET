...
public class SysUserSeedData : ISqlSugarEntitySeedData<SysUser>
{
    ...
    public IEnumerable<SysUser> HasData()
    {
        return new[]
        {
            ...
            new SysUser{ Id=252885263003724, UserName="Admin", Password="e10adc3949ba59abbe56e057f20f883e", NickName="管理员", RealName="管理员", Phone="18020030720", Birthday=DateTime.Parse("1986-06-28"), Sex=GenderEnum.Male, UserType=UserTypeEnum.Admin, Remark="管理员", CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrgId=252885263003731, PosId=252885263003720, TenantId=142307070918781 }
        };
    }
}