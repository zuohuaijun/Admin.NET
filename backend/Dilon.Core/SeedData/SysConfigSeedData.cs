    ...
    public class SysConfigSeedData : IEntitySeedData<SysConfig>
    {
        ...
        public IEnumerable<SysConfig> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]
            {
                ...
                new SysConfig{Id=33, Name="演示环境", Code="DILON_DEMO_ENV_FLAG", Value="true",SysFlag="Y", Remark="演示环境的开关,true-打开，false-关闭，如果演示环境开启，则只能读数据不能写数据", Status=0, GroupCode="DEFAULT"},
            };
        }
    }
}
