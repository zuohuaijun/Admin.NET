export default {
  ...
  login: {
    ...
    signInTitle: '有可能是最好用的.NET中后台',
    signInDesc:
      '基于.NET6/Furion实现的通用管理平台，前端采用Vue3/Vben框架。整合最新技术，模块插件式开发，前后端分离，开箱即用。集成SqlSugar、多租户、缓存、数据校验、鉴权、事件总线、动态API、通讯、远程请求、任务调度、gRPC等众多黑科技。代码简洁、易扩展，让开发更简单、更通用、更流行！',
    policy: '我同意xxx隐私政策',
